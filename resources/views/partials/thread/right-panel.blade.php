<div>
    <div class="index-right-panel-container border-box">
        <div class="index-right-panel toggle-box">
            <div class="flex space-between">
                <p class="no-margin mb4 fs15 bold blue unselectable">Author</p>
                ...
                <div class="my8">
                    ...
                    <div class="flex my8">
                        ...
                        <div class="flex align-center">
                            ...
                            <p class="fs12 no-margin">Active</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="index-right-panel-container border-box mt8">
        <div class="index-right-panel">
            <p class="bold no-margin mb8 fs13">{{ __("Not the") }} {{ $thread_type }} {{ __("you're looking for ?") }}</p>
