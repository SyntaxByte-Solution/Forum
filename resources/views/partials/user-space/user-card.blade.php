        ...
        <div class="my4">
            <div class="flex align-center">
                <div class="flex align-center">
                    ...
                    <p class="inline-block my4 fs12">{{__('Replies')}}: </p><span class="bold ml8">{{ $user->posts_count() }}</span>
                </div>
            </div>
        </div>
        <div class="my4">
        ...
        <div class="my4">
            <div class="flex align-center">
                <div class="flex align-center">
                    ...
                    <p class="inline-block my4 fs12">{{__('Votes casts')}}: </p><span class="bold ml8">{{ $user->votes_count() }}</span>
                </div>
            </div>
        </div>
    </div>
