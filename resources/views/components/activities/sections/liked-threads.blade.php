            ...
            <div class="full-center" style="margin-top: 46px">
                <div class="flex flex-column align-center">
                    ...
                    @if(\Illuminate\Support\Facades\Auth::check() && auth()->user()->id == $user->id)
                        <p class="fs20 text-center bold my8">{{ __("You don't have any liked discussions for the moment") }} !</p>
                        <div class="flex">
                    ...
                    @else
                        <p class="fs20 text-center bold my8">{{ __("This user has no liked discussions for the moment") }} !</p>
                    @endif
                </div>
            </div>
        @endif
