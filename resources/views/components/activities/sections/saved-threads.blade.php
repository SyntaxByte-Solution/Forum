        ...
        @if(!$savedthreads->count())
            <div class="full-center text-center" style="margin: 46px auto 0 auto; width: 90%">
                <div class="flex flex-column align-center">
                    ...
                    <p class="fs20 bold my8" style="margin-bottom: 2px">{{ __("You don't have any saved discussions for the moment") }} !</p>
                    <div class="flex">
                        <div class="my4">
                            <p class="no-margin">{{ __("Explore other users' discussions and click on save to save discussions into your bookmark") }}</p>
                        </div>
                    </div>
                </div>
            </div>
