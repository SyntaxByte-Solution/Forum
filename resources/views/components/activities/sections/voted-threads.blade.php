<div class="activities-section activities-voted-threads-section">
    <h3 class="no-margin forum-color flex align-center unselectable mb8">
        <svg class="size4 mr4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 29.11 29.11">
            <image width="30" height="30" transform="translate(0 -0.89)" xlink:href="data:image/png;base64,"/>
        </svg>
        {{ __('Voted threads') }} [<span class="current-thread-count mx4">{{ 6 * ($votedthreads->count() / 6) }}</span> / {{ $votedthreads_count }} ]
    </h3>
