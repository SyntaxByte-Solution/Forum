    ...
    <div class="index-middle-width middle-container-style">
        ...
        <div class="full-center thread-container-box" style="margin-top: 20px; padding: 20px">
            <div class="flex flex-column align-center">
                ...
                <p class="fs20 bold gray text-center" style="margin: 10px 0 16px 0">{{ __("There are no discussions at the moment try out later or change the category or date filter") }}.</p>
                <p class="my4 text-center">{{ __("Or start your own discussion") }} <a href="{{ route('thread.add') }}" class="link-path">{{__('here')}}</a></p>
            </div>
        </div>
        @else
            @if($hasmore)
