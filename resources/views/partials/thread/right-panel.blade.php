<div>
    <div>
        <div class="right-panel-header-container space-between">
            ...
            <a href="{{ route('user.profile', ['user'=>$thread_owner->username]) }}" class="blue no-underline bold">{{ __('Profile') }}</a>
        </div>
        <div class="relative us-user-media-container mx8 my8">
            ...
            <div class="us-after-cover-section flex" style="margin-left: 20px; margin-top: -40px">
                ...
                <div class="ms-profile-infos-container" style="margin-top: 45px">
                    <div class="flex align-center">
                        <a href="{{ $thread_owner->profilelink }}" class="fs17 bold blue no-underline flex align-center">
                        ...
                        <div class="ml4" style='margin-top: 1px'>
                            ...
                            @endphp
                            <div class="flex align-center" title="@if(Cache::has('user-is-online-' . $thread_owner->id)) Online @else Offline @endif">
            ...
            <div class="my8">
                <p class="fs12 gray no-margin flex align-center">
                    ...
                    <span class="black">{{ (new \Carbon\Carbon($thread_owner->created_at))->toDayDateTimeString() }}</span>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="border-box mt8">
            <div>
                <div class="right-panel-header-container">
                    <p class="bold no-margin fs15 bblack">{{ __("Not the discussion you're looking for ?") }}</p>
                </div>
                <div class="px8 mx8">
        ...
        <div class="mt8 py8">
            <div class="toggle-box">
                ...
                <div class="mx8 px8">
                    ...
                    <p class="fs12 my8 flex"><strong class="mr4">II.</strong> {{ __('Stick to the topic when replying to discussions or replies created by others') }}.</p>
