<div class="mt8">
    <div class="right-panel-header-container">
        <div class="size20 sprite sprite-2-size rating20-icon mr4"></div>
    ...
    <div class="mx8 px8 my8">
        ...
        <div class="full-center">
            ...
            <a href="" class="mx4 emoji-button">
                <img src="{{ asset('assets/images/icons/emoji-thinking.svg') }}" class="mx4 size28 emoji-unfilled" alt="">
                <img src="{{ asset('assets/images/icons/emoji-thinking-filled.png') }}" class="mx4 size28 none emoji-filled" alt="">
                <input type="hidden" class="feedback-emoji-state" value="sceptic">
            </a>
            <a href="" class="mx4 emoji-button">
                <img src="{{ asset('assets/images/icons/emoji-sceptic.svg') }}" class="mx4 size28 emoji-unfilled" alt="">
                <img src="{{ asset('assets/images/icons/emoji-sceptic-filled.png') }}" class="mx4 size28 none emoji-filled" alt="">
                <input type="hidden" class="feedback-emoji-state" value="so-so">
            </a>
            <a href="" class="mx4 emoji-button">
                <img src="{{ asset('assets/images/icons/emoji-happy.svg') }}" class="mx4 size28 emoji-unfilled" alt="">
                <img src="{{ asset('assets/images/icons/emoji-happy-filled.png') }}" class="mx4 size28 none emoji-filled" alt="">
                <input type="hidden" class="feedback-emoji-state" value="happy">
            </a>
            <a href="" class="mx4 emoji-button">
                <img src="{{ asset('assets/images/icons/emoji-veryhappy.svg') }}" class="mx4 size28 emoji-unfilled" alt="">
                <img src="{{ asset('assets/images/icons/emoji-veryhappy-filled.png') }}" class="mx4 size28 none emoji-filled" alt="">
        ...
        <div class="flex space-between">
            <a href="" class="mx4 block-click">
                ...
                @else
                    <img src="{{ asset('assets/images/icons/emoji-sad.svg') }}" class="mx4 size28 emoji-unfilled" style="opacity: 0.5" alt="">
                @endif
            </a>
            <a href="" class="mx4 block-click">
                @if($feedback_state == 'sceptic')
                    <img src="{{ asset('assets/images/icons/emoji-thinking-filled.png') }}" class="mx4 size28 emoji-filled" alt="">
                @else
                    <img src="{{ asset('assets/images/icons/emoji-thinking.svg') }}" class="mx4 size28 emoji-unfilled" style="opacity: 0.5" alt="">
                @endif
            </a>
            <a href="" class="mx4 block-click">
                @if($feedback_state == 'so-so')
                    <img src="{{ asset('assets/images/icons/emoji-sceptic-filled.png') }}" class="mx4 size28 emoji-filled" alt="">
                @else
                    <img src="{{ asset('assets/images/icons/emoji-sceptic.svg') }}" class="mx4 size28 emoji-unfilled" style="opacity: 0.5" alt="">
                @endif
            </a>
            <a href="" class="mx4 block-click">
                @if($feedback_state == 'happy')
                    <img src="{{ asset('assets/images/icons/emoji-happy-filled.png') }}" class="mx4 size28 emoji-filled" alt="">
                @else
                    <img src="{{ asset('assets/images/icons/emoji-happy.svg') }}" class="mx4 size28 emoji-unfilled" style="opacity: 0.5" alt="">
                @endif
            </a>
            <a href="" class="mx4 block-click">
                @if($feedback_state == 'veryhappy')
                    <img src="{{ asset('assets/images/icons/emoji-veryhappy-filled.png') }}" class="mx4 size28 emoji-filled" alt="">
                @else
                    <img src="{{ asset('assets/images/icons/emoji-veryhappy.svg') }}" class="mx4 size28 emoji-unfilled" style="opacity: 0.5" alt="">
                @endif
            </a>
        </div>
        @endcanemoji
