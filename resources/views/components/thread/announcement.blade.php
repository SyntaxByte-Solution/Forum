                    ...
                    <div class="flex align-center space-between">
                            ...
                            <div class="flex align-center move-to-right">
                                <div class="simple-border-container mr4">
                                    ...
                                    <p class="fs12 no-margin unselectable">{{ $announcement->likes->count() }} likes</p>
                                </div>
                                <div class="simple-border-container mr4">
                                    ...
                                    <p class="fs12 no-margin unselectable">{{ $announcement->posts->count() }} replies</p>
                                    <p class="no-margin gray ml4 fs11">@if($announcement->replies_off) ({{ __('Replies disabled') }}) @endif</p>
                                </div>
