<div class="report-resource-container thread-report-container none">
    ...
    <div class="@if(!$thread->already_reported) none @endif already-reported-container">
        ...
        <div>
            ...
            <label class="resource-report-option">
                ...
                <div class="ml8">
                    ...
                    <p class="no-margin gray">{{__('This discussion has severe formatting or content problems. This discussion is unlikely to be salvageable through editing, and might need to be removed')}}.</p>
                </div>
            </label>
