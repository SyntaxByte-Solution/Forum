...
@section('content')
    ...
    <div class="index-middle-width middle-container-style">
        <input type="hidden" autocomplete="off" id="explore-page" value="1">
        ...
        <div class="flex space-between py4 stick-after-header">
            <div class="relative">
                ...
                <div class="suboptions-container thread-add-suboptions-container" style="width: 250px">
                    <div class="thread-add-suboption sort-by-option flex">
        ...
        <div class="threads-global-container mt8">
