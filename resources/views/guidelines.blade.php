    ...
    <div id="middle-padding">
        <div>
            ...
            <div class="flex align-center">
                <h2 class="no-margin my8">{{__('Welcome to')}}</h2>
                ...
                <h2><span style="color: #d02424;">MOROCCAN GLADIATOR</span> {{__('Forum')}}</h2>
            </div>
            ...
            <div style="margin-left: 16px">
                ...
                <p class="text my8"><b>2.</b> {{ __("Slanderous posts are not allowed. If a post is deemed slanderous, the discussion may be deleted or moved to the penalty box and the poster may be boxed or even banned") }}.</p>
                <p class="text my8"><b>3.</b> {{ __("Any obvious site promotions will be assumed to be meant for the promotions area, and will be moved there if not deleted. Any other off-topic discussions will be relocated to the appropriate forum and/or deleted accordingly") }}.</p>
                <p class="text my8"><b>4.</b> {{ __("Intentionally repetitive discussions or replies posted by the same user may be locked, deleted, or consolidated") }}.</p>
                <p class="text my8"><b>5.</b> {{ __("Any discussion in the forum which deteriorate to arguments between two or more users will be moved to the penalty box, or deleted at the discretion of our Moderators") }}.</p>
