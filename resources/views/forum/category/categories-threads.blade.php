        ...
        <div class="full-width">
            ...
            <div class="full-center thread-container-box" style="margin-top: 20px; padding: 20px">
                <div class="flex flex-column align-center">
                    ...
                    <p class="fs20 bold gray text-center" style="margin: 10px 0 16px 0">{{ __("There are no threads at the moment try out later or change the category or date filter") }}.</p>
