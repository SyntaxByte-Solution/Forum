    ...
    <div class="flex thread-component">
        <div class="thread-vote-section">
            <div class="vote-box full-center flex-column relative">
                ...
                <p class="bold fs15 text-center votable-count" style="margin: 1px 0 2px 0">{{ $totalvotevalue }}</p>
        ...
        <div class="thread-main-section">
                                ...
                                <div class="visibility-box">
                                    <div class="relative">
                                        ...
                                        <div class="suboptions-container suboptions-container-right-style" style="left: 0; width:max-width">
                                            <p class="fs13 bold ml8 my8">{{ __('Discussion visibility') }}</p>
            ...
            <div class="thread-bottom-section space-between">
                ...
                <div class="flex align-center">
                    <div class="relative">
                        <div class="flex align-center pointer button-with-suboptions copy-container-button">
                            <svg class="mr4 size14 path-blue-when-hover" fill="#1c1c1c" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M326.61,185.39A151.92,151.92,0,0,1,327,400l-.36.37-67.2,67.2c-59.27,59.27-155.7,59.26-215,0s-59.27-155.7,0-215l37.11-37.1c9.84-9.84,26.78-3.3,27.29,10.6a184.45,184.45,0,0,0,9.69,52.72,16.08,16.08,0,0,1-3.78,16.61l-13.09,13.09c-28,28-28.9,73.66-1.15,102a72.07,72.07,0,0,0,102.32.51L270,343.79A72,72,0,0,0,270,242a75.64,75.64,0,0,0-10.34-8.57,16,16,0,0,1-6.95-12.6A39.86,39.86,0,0,1,264.45,191l21.06-21a16.06,16.06,0,0,1,20.58-1.74,152.65,152.65,0,0,1,20.52,17.2ZM467.55,44.45c-59.26-59.26-155.69-59.27-215,0l-67.2,67.2L185,112A152,152,0,0,0,205.91,343.8a16.06,16.06,0,0,0,20.58-1.73L247.55,321a39.81,39.81,0,0,0,11.69-29.81,16,16,0,0,0-6.94-12.6A75,75,0,0,1,242,270a72,72,0,0,1,0-101.83L309.16,101a72.07,72.07,0,0,1,102.32.51c27.75,28.3,26.87,73.93-1.15,102l-13.09,13.09a16.08,16.08,0,0,0-3.78,16.61,184.45,184.45,0,0,1,9.69,52.72c.5,13.9,17.45,20.44,27.29,10.6l37.11-37.1c59.27-59.26,59.27-155.7,0-215Z"/></svg>
                        </div>
