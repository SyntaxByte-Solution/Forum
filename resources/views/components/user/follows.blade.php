<div class="follow-box-item follow-box">
    ...
    <div class="move-to-right height-max-content button-wraper-style @auth follow-resource follow-button-with-icon @endauth @guest login-signin-button @endguest">
