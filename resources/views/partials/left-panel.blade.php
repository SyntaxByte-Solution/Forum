    ...
    <div>
        ...
        <div class="relative toggle-box pb8">
            <a href="" class="left-panel-item toggle-container-button simple-suboption-button lp-wpadding @if($page == 'search') {{ 'lp-selected bold white white' }} @endif">
                ...
                {{__('Search')}} 
                <svg class="toggle-arrow mx4 size7" style="margin-top: 1px" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30.02 30.02">
                    @if($page == 'search')
                    <path d="M28.63,13.41l-11,9.35a4,4,0,0,1-5.18,0l-11-9.35a4,4,0,1,1,5.18-6.1L15,14.46l8.42-7.15a4,4,0,1,1,5.18,6.1Z"/>
                    @else
            ...
            <div class="toggle-container" @isset($subpage) @if($page == 'search') style="display: block" @endif @endisset>
                ...
                <div class="relative">
                    <a href="{{ route('users.search') }}" @isset($subpage) @if($subpage == 'users-search') style="color: #53baff" @endif @endisset class="left-panel-item lp-sub-item @if($page == 'search') {{ 'lp-selected' }} @endif">
                        <svg class="mr4 size14" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 511 511"><path d="M497.26,327.47a131,131,0,0,0-77.32-98,80.39,80.39,0,0,0,28.67-61.71c0-44.08-35.24-79.94-78.55-79.94s-78.55,35.86-78.55,79.94a80.39,80.39,0,0,0,28.7,61.74,127.12,127.12,0,0,0-18.91,10A130.69,130.69,0,0,0,263,277.2a161.66,161.66,0,0,0-32.76-16.75,99.63,99.63,0,0,0,41.13-80.89c0-54.66-43.66-99.13-97.33-99.13S76.73,124.9,76.73,179.56a99.63,99.63,0,0,0,41.13,80.89c-52.92,19.8-93.51,66.88-104,126.16A37.46,37.46,0,0,0,22,417.28a36.91,36.91,0,0,0,28.34,13.29H297.77a36.91,36.91,0,0,0,28.34-13.29,37.46,37.46,0,0,0,8.19-30.67,170.89,170.89,0,0,0-5.23-21.34H465.82a31.77,31.77,0,0,0,24.4-11.44A32.21,32.21,0,0,0,497.26,327.47ZM319.9,167.75c0-28.43,22.5-51.55,50.16-51.55s50.16,23.12,50.16,51.55-22.5,51.56-50.16,51.56S319.9,196.18,319.9,167.75ZM105.12,179.56c0-39,30.93-70.74,68.94-70.74S243,140.56,243,179.56s-30.93,70.74-68.94,70.74S105.12,218.57,105.12,179.56ZM304.35,399.05a8.53,8.53,0,0,1-6.58,3.13H50.35a8.53,8.53,0,0,1-6.58-3.13,9,9,0,0,1-2-7.48C53.39,326.17,109,278.69,174.06,278.69s120.68,47.48,132.29,112.88A9,9,0,0,1,304.35,399.05Zm164.11-63.46a3.44,3.44,0,0,1-2.63,1.29H317.13A165,165,0,0,0,285.29,295c18.49-29.41,50.1-47.28,84.77-47.28,48.79,0,90.53,35.63,99.25,84.73A3.79,3.79,0,0,1,468.46,335.59Z" style="stroke:#fff;stroke-miterlimit:10;stroke-width:15px"/></svg>
                        {{__('Users Search')}}
                    </a>
                    @isset($subpage)
