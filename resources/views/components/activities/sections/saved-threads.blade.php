        ...
        @if(!$savedthreads->count())
            <div class="full-center" style="margin-top: 46px">
                <div class="flex flex-column align-center">
                    ...
                    <p class="fs20 bold my8" style="margin-bottom: 2px">{{ __("You don't have any saved threads for the moment !") }}</p>
                    <div class="flex">
                        <div class="my4">
                            <p class="no-margin">{{ __("Eplore other peoples' discussions and hit save to save discussions into your bookmark") }}</p>
                        </div>
                    </div>
                </div>
            </div>
