...
@section('content')
    ...
    <div id="middle-padding">
        <div>
            ...
            <p class="full-center fs15" style="margin: 20px 0 10px 0;">
                <em class="text-center" style="width: 80%; min-width: 200px">{{ __("Below you’ll find answers to our most commonly asked questions. If you don’t find the answer you are looking for, you could ask a question using the form at the bottom") }}</em>
            </p>
            
            <h2 style="margin: 28px 0 10px 0">{{ __('TOP FAQs') }}</h2>
            <div class="qa-wrapper">
                <div class="flex space-between">
                    <div class="flex">
                        ...
                        <div>
                            <p class="no-margin fs16 bold unselectable">This is another dumb question of ya ? :)</p>
                            <div class="faq-answer mt8 none">
                                ...
                                <p class="text">This is an answer to your dumb question :)This is an answer to your dumb question :)This is an answer to your dumb question :)This is an answer to your dumb question :)This is an answer to your dumb question :)This is an answer to your dumb question :)This is an answer to your dumb question :)This is an answer to your dumb question :)This is an answer to your dumb question :)</p>
                            </div>
                        </div>
                    </div>
