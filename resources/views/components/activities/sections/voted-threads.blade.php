            ...
            <div class="full-center" style="margin-top: 46px">
                <div class="flex flex-column align-center">
                    ...
                    @if(\Illuminate\Support\Facades\Auth::check() && auth()->user()->id == $user->id)
                        <p class="fs20 text-center bold my8" style="margin-bottom: 2px">{{ __("You have not voted any discussions yet") }} !</p>
                        <div class="flex">
                            <div class="flex align-center move-to-middle my4">
                                <p class="no-margin">{{ __("To vote a discussion, click on the up or down buttons in the left side of discussion post") }}</p>
                            </div>
                        </div>
                    @else
