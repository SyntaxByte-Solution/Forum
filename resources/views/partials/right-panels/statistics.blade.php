    ...
    <div class="mx8 py8">
        ...
        <div class="ml8">
            <div class="flex align-center">
                ...
                <p class="my4 fs13">{{ __('Total forums discussions') }}: {{ \App\Models\Thread::count() }}</p>
            </div>
            <div class="flex align-center my4">
                ...
                <p class="my4 fs13">{{ __('Total replies') }}: {{ \App\Models\Post::count() }}</p>
            </div>
            <div class="mt8 my4">
                <div class="flex">
                    ...
                    <div>
                        <p class="no-margin fs13">{{__('Total members')}}: {{ \App\Models\User::count() }}</p>
                        @php
        ...
        <div class="ml8">
            ...
            <div class="flex my4">
                ...
                <div>
                    <p class="no-margin fs13">Replies: {{ \App\Models\Post::today()->count() }}</p>
                    @php
