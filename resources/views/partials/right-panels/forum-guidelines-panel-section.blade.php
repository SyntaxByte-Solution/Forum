...
<div class="index-right-panel my8">
    <p class="bold no-margin unselectable blue my4">{{ __('Forum Rules & Policies') }}</p>
    <p class="fs12 my8"><strong>1. {{ __('No Spam / Advertising / Self-promote in the forums') }}</strong></p>
    <p class="fs12 my8 ml8">{{ __('These forums define spam as unsolicited advertisement for goods, services and/or other web sites, or posts with little, or completely unrelated content. Do not spam the forums with links to your site or product, or try to self-promote your website, business or forums etc.
