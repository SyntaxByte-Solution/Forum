            ...
            <div class="full-width">
                ...
                <div class="flex">
                    <div class="half-width mx8">
                        ...
                        <div class="input-container">
                            <label for="city" class="label-style-2 mb2">{{ __('City') }} @error('city') <span class="error ml4">*</span> @enderror</label>
                        ...
                        <div class="input-container">
                            <label for="phone" class="label-style-2 mb2">{{ __('Phone') }} @error('phone') <span class="error ml4">*</span> @enderror</label>
