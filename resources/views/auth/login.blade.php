...
<div class="auth-card" style="border-radius: 0; margin: 60px auto 8px auto">
    <div>
        <a href="/"><img id="login-top-logo" class="move-to-middle" src="{{ asset('assets/images/logos/large-logo(200black).png') }}" alt="logo"></a>
    </div>
    <h1>{{ __('Login') }}</h1>
    ...
    <div class="line-separator"></div>
    <div>
        <div class="flex align-center"><strong class="mr4">{{__('Not a member')}}?</strong> <a href="{{ route('register') }}" class="link-style no-underline">{{ __('Signup now') }}</a></div>
    </div>
</div>
@endsection
